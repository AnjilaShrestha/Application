...
import com.example.ashres68.application.Model.Users;
...
public class ResetPasswordActivity extends AppCompatActivity
{
    ...
    private void setAnswers(){
        ...
        if (question1.equals("") && question2.equals("") ){
            Toast.makeText(ResetPasswordActivity.this, "Please write your password...", Toast.LENGTH_SHORT).show();
            ...
            ref.child("Security Questions").updateChildren(userdataMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                ...
                public void onComplete(@NonNull Task<Void> task) {
                    if(task.isSuccessful()){
                        Toast.makeText(ResetPasswordActivity.this, "You have answer questions sucessfully", Toast.LENGTH_SHORT).show();
            ...
            ref.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    if (dataSnapshot.exists()){
                        ...
                        Toast.makeText(ResetPasswordActivity.this, "Phone number doesnot exist", Toast.LENGTH_SHORT).show();
